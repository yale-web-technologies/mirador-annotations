...
=end
  ...
  def setRedisKeys
    ...
    #redisValue_bv11 =open("http://annotations.lotb.yale.edu/getAnnotationsViaList?canvas_id=http://manifests.ydc2.yale.edu/LOTB/canvas/panel_01/getAnnotationsViaList?canvas_id=http://manifests.ydc2.yale.edu/LOTB/canvas/bv11").read
    #redisValue_bv11.gsub!(/=>/,":")
    #@redis.set("http://manifests.ydc2.yale.edu/LOTB/canvas/bv11",redisValue_bv11)
    #p "both keys set"
  end
